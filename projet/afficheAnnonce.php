...
//donnée de l'utilisateur qui a fait l'annonce 

$requete_annonceur = "select nom,prenom,date_naissance,telephone,email from utilisateur where id='$idu';";
$resultat_annonceur = executeRequete($con,$requete_annonceur);
$ligne_annonceur=mysqli_fetch_array($resultat_annonceur);

$nom = $ligne_annonceur[0];
$prenom = $ligne_annonceur[1];
$date_naissance = $ligne_annonceur[2];
$telephone = $ligne_annonceur[3];
$email = $ligne_annonceur[4];
...
<h2 class="w3-container w3-green">Informations Annonceur</h2>

<p  class="w3-panel w3-leftbar w3-sand w3-xlarge w3-serif">ID_Annonceur: <?php echo $idu; ?></p>
<p  class="w3-panel w3-leftbar w3-sand w3-xlarge w3-serif">Nom: <?php echo $nom; ?></p>
<p  class="w3-panel w3-leftbar w3-sand w3-xlarge w3-serif">Prenom: <?php echo $prenom; ?></p>
<p  class="w3-panel w3-leftbar w3-sand w3-xlarge w3-serif">Date_naissance: <?php echo $date_naissance; ?></p>
<p  class="w3-panel w3-leftbar w3-sand w3-xlarge w3-serif">Telephone: <?php echo $telephone; ?></p>
<p  class="w3-panel w3-leftbar w3-sand w3-xlarge w3-serif">Email: <?php echo $email; ?></p>
...
echo "<div> <a href='contactVendeur?idu=$idu'><input style='width:100%;' class='w3-btn w3-blue' type='submit' value='Contacter' > </a></div>";
